...
public abstract class RestClientBase {
	...
	protected String connectOnce(String urlString) throws NDULibraryAuthenticationException,
	...
	protected URLConnection getFileDownloadConnection(String urlString) throws NDULibraryConnectionException,
	...
	protected InputStream getStreamNoValidation(String _URL) throws IOException, NDULibraryAuthenticationException {
		...
		if ((statusCode == 403) || (statusCode == 500)) // 500 errors also show
														// up when the user is
														// unauthorized...
														// weird.
		{
